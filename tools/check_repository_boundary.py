...
for f in a.root.rglob('*'):
 ...
 if rel.parts[0] not in {'tools','scripts','tests','references','templates','README.md','SKILL.md','LICENSE','requirements.txt','requirements-alignment.txt','.gitignore'}:errors.append(str(rel)+': outside public allowlist')
